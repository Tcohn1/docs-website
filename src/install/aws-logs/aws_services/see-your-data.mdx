...
Once the new stack is created, your collected logs gets forwrded to New Relic. to see your data 

* Navigate to the [logs UI](https://one.newrelic.com/launcher/logger.log-launcher)
* OR navigate to the [New query explorer] to query your data (/docs/chart-builder/use-chart-builder/choose-data/use-advanced-nrql-mode-specify-data)
